...
def main(_):
  ...
  for split in ['val', 'test']:
    ...
    record_filenames = tf.io.gfile.glob(FLAGS.input_files.format(split))
    ...
    input_meta_data.update({
      f'{split}_image_input_path':
        f'{FLAGS.eval_data_dir}/wit_v1.ai.{split}.en.recordio.image-00001-of-00001',
      f'{split}_text_input_path': 
        f'{FLAGS.eval_data_dir}/wit_v1.ai.{split}.en.recordio.text-00001-of-00001',
    ...
    for domain, examples in [('image', image_serialized_examples),
      ...
      filename = os.path.join(
          FLAGS.eval_data_dir, f'wit_v1.ai.{split}.en.recordio.{domain}-00001-of-00001')
